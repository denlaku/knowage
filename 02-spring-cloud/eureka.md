...
EurekaServerAutoConfiguration 注册中心自动配置

EurekaDashboardProperties
InstanceRegistryProperties

EurekaServerConfig 注册中心配置信息
...
AbstractInstanceRegistry
	PeerAwareInstanceRegistry
		\#register(InstanceInfo, int, boolean) 服务注册
		\#super.register()
        	\#replicateToPeers()
		\#replicateInstanceActionsToPeers()
		\#scheduleRenewalThresholdUpdateTask() 自我保护机制
...
EurekaServerContext  ->  DefaultEurekaServerContext#initialize()
...
EurekaClientAutoConfiguration 客户端自动配置
	EurekaClientConfigBean
	EurekaInstanceConfigBean
	DiscoveryClient
	EurekaServiceRegistry
	EurekaClientConfiguration
		\#eurekaClient() -> EurekaClient : CloudEurekaClient 
			scheduler 
			...
			register()
			renew()
		\#eurekaApplicationInfoManager() -> ApplicationInfoManager 
		\#eurekaRegistration() -> EurekaRegistration
			

EurekaClientConfig  客户端配置信息
	EurekaClientConfigBean
...
CloudEurekaInstanceConfig  实例配置信息
	EurekaInstanceConfigBean
